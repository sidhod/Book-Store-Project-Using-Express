      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return WishListService.getAllBooks();
          case 3:
            data = _context.sent;
...
var addTowishList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return WishListService.addTowishList(req.body, req.params._id);
          case 3:
            data = _context2.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function addTowishList(_x4, _x5, _x6) {
...
var removeBookFromWishList = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return WishListService.removeBookFromWishList(req.body, req.params._id);
          case 3:
            data = _context3.sent;
  ...
  return function removeBookFromWishList(_x7, _x8, _x9) {
