...
var booksService = _interopRequireWildcard(require("../services/books.service"));
...
var paginationBooks = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return booksService.paginationBooks(req.params.page);
          case 3:
            data = _context2.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function paginationBooks(_x4, _x5, _x6) {
...
var searchBooks = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return booksService.searchBooks(req.body);
          case 3:
            data = _context3.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function searchBooks(_x7, _x8, _x9) {
...
var sortBooks = /*#__PURE__*/function () {
  ...
  return function sortBooks(_x10, _x11, _x12) {
...
var sortondateBooks = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return booksService.sortondateBooks();
          case 3:
            data = _context5.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
  ...
  return function sortondateBooks(_x13, _x14, _x15) {
