...
var getBookById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return CartService.getBookById(req.body, req.params._id);
          case 3:
            data = _context2.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
              data: data,
              message: 'books successfully'
            });
            _context2.next = 10;
            break;
          case 7:
  ...
  return function getBookById(_x4, _x5, _x6) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return CartService.addToCart(req.body, req.params._id);
          case 3:
            data = _context3.sent;
            res.status(_httpStatusCodes["default"].OK).json({
              code: _httpStatusCodes["default"].OK,
...
var removeBookFromCart = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return CartService.removeBookFromCart(req.body, req.params._id);
          case 3:
            data = _context4.sent;
  ...
  return function removeBookFromCart(_x10, _x11, _x12) {
...
var increaseBook = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return CartService.increaseBook(req.body, req.params._id);
          case 3:
            data = _context5.sent;
            res.status(_httpStatusCodes["default"].CREATED).json({
              code: _httpStatusCodes["default"].CREATED,
  ...
  return function increaseBook(_x13, _x14, _x15) {
...
var decreaseBook = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return CartService.decreaseBook(req.body, req.params._id);
          case 3:
            data = _context6.sent;
            res.status(_httpStatusCodes["default"].CREATED).json({
              code: _httpStatusCodes["default"].CREATED,
  ...
  return function decreaseBook(_x16, _x17, _x18) {
